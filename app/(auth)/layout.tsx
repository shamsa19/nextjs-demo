...
const AuthLayout = ({children} : {children: React.ReactNode}) => {
  return (
    <main className="flex min-h-screen items-center justify-center bg-auth-light
       ...
       min-w-full rounded-[10px] border px-4 py-10 shadow-md sm:min-w-[520px] sm:px-8">
        <div className='flex items-center justify-between gap-2'>
          <div className='space-y-2.5'>
            ...
            <p className='paragrah-regular text-dark100_light900'>
            To get your questions answered
            </p>
          </div>
        <Image src="/images/site-logo.svg" 
        alt="DevFlow Logo" width={50} height={50} className='object-contain' />
        </div>
          {children}
          <SocialAuthForm/>
      </section>
